...
if acknowledgement:
    ...
    first_video_thumbnail = results['video_results'][0]['thumbnail']['rich'] ? results['video_results'][0]['thumbnail']['rich'] : results['video_results'][0]['thumbnail']['static']
    second_video_link = results['video_results'][1]['link']
    second_video_title = results['video_results'][1]['title']
    second_video_thumbnail = results['video_results'][1]['thumbnail']['rich'] ? results['video_results'][1]['thumbnail']['rich'] : results['video_results'][1]['thumbnail']['static']
